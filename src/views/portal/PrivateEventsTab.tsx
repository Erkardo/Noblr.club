    ...
    >
      ...
      <div className="grid grid-cols-1 gap-12">
        {UPCOMING_EVENTS.map((evt, i) => {
          ...
          return (
          <div key={i} className="group relative border border-accent-20 bg-bg-2/70 overflow-hidden flex flex-col md:flex-row shadow-2xl">
            {/* Image Section */}
            <div className="md:w-2/5 aspect-[4/3] md:aspect-auto relative overflow-hidden bg-bg-2">
              <div className="absolute inset-0 z-10 bg-gradient-to-t from-bg-base via-transparent to-transparent md:bg-gradient-to-r" />
              <div className="absolute top-4 left-4 z-20 px-3 py-1 bg-text-main/50 backdrop-blur-md border border-accent/30 font-caps text-[8px] tracking-[0.2em] text-text-main uppercase">
                Classified // {evt.id}
              </div>
            ...
            <div className="p-5 md:p-12 md:w-3/5 flex flex-col justify-between relative z-20">
              <div>
                ...
                <h3 className="font-display text-4xl border-l-[3px] border-accent pl-5 font-light text-text-main mb-6 tracking-tight leading-none group-hover:text-text-main transition-colors">{evt.title}</h3>
              ...
              <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pt-8 border-t border-accent-20">
                <div>
                  ...
                  <div className={`mt-3 font-caps text-[8px] tracking-[0.2em] uppercase ${isFull ? 'text-text-dim' : 'text-error'}`}>
                    {evt.urgency}
                  </div>
                </div>
      ...
      <div className="mt-24 pt-16 border-t border-accent-20">
        <div className="flex justify-between items-end border-b border-accent-20 pb-4 mb-12">
          ...
          <div className="font-sans text-[10px] tracking-[0.1em] text-accent/60 uppercase text-right">
            Visual Records <span className="text-error">Purged</span><br/>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {PAST_EVENTS.map((evt, i) => (
            <div key={i} className="group border border-accent-20 bg-bg-2/60 relative flex flex-col p-5 md:p-12">
              ...
              <div className="flex justify-between items-start mb-8">
                ...
                <div className="font-caps text-[8px] tracking-[0.3em] text-error uppercase border border-error/30 px-2 py-1">
                  Concluded
                </div>
              </div>
              ...
              <div className="w-full bg-bg-2 border border-accent/10 py-10 flex flex-col items-center justify-center relative overflow-hidden">
                ...
                <div className="relative z-10 flex flex-col items-center">
                  <div className="w-8 h-8 border border-error/40 rounded-full flex items-center justify-center mb-4">
                    <div className="w-[1px] h-4 bg-error/50 rotate-45 absolute" />
                    <div className="w-[1px] h-4 bg-error/50 -rotate-45 absolute" />
                  </div>
